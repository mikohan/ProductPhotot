...
const images = [
  '/img/portfolio_cars/mercedes_sasha/001.jpg',
  '/img/portfolio_cars/mercedes_sasha/002.jpg',
  '/img/portfolio_cars/mercedes_sasha/003.jpg',
  '/img/portfolio_cars/mercedes_sasha/004.jpg',
  '/img/portfolio_cars/mercedes_sasha/005.jpg',
  '/img/portfolio_cars/mercedes_sasha/006.jpg',
  '/img/portfolio_cars/mercedes_sasha/007.jpg',
  '/img/portfolio_cars/mercedes_sasha/008.jpg',
  '/img/portfolio_cars/mercedes_sasha/009.jpg',
  '/img/portfolio_cars/mercedes_sasha/010.jpg',
  '/img/portfolio_cars/mercedes_sasha/011.jpg',
  '/img/portfolio_cars/mercedes_sasha/012.jpg'
];
...
const ProjectDetails: NextPage = () => {
  ...
  return (
    <Fragment>
      <Head>
        <title>{`Car Photography Project Mercedes C300- ${company.companyName}`}</title>
        <meta
          name="description"
          content={`Car Photography Project Mercedes C300 of our creative photo studio - ${company.companyName}`}
        />
      </Head>
      <PageProgress />
            ...
            <div className="row">
              <div className="col-md-10 col-lg-8 col-xl-7 mx-auto">
                <div className="post-header">
                  ...
                  <h1 className="display-1 mb-3">One of the project of Car Photography. Mercedes C300.</h1>
                  <p className="lead px-md-12 px-lg-12 px-xl-15 px-xxl-18">Mercedes C300</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="col-12">
                <article className="mt-n21">
                  <FigureImage
                    width={2400}
                    height={1640}
                    src="/img/portfolio_cars/mercedes_sasha/cover.jpg"
