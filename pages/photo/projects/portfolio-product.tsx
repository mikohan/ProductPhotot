            ...
            <div className="row">
              <div className="col-md-10 col-lg-8 col-xl-7 mx-auto">
                <div className="post-header">
                  ...
                  <h1 className="display-1 mb-3">One of the project in a product photography.</h1>
                  <p className="lead px-md-12 px-lg-12 px-xl-15 px-xxl-18">
                  Few photos of cosmetics and accessories
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="col-12">
                <article className="mt-n21">
                  <FigureImage
                    width={2560}
                    height={1706}
                    src="/img/portfolio_cars/product_diary/0003.jpg"
                    className="rounded mb-8 mb-md-12"
                  />

                  <ProjectDetailsContent
                    title="About the Project"
                    content={`We create high quality product photography for clients to use on various platforms such as amazon, shopify, wordpress, magento, square space, wix, bigcommerce, woocommerce, etc.`}
                    projectClient="Gary"
                  ...
                  <div className="row mt-8 mt-md-12">
                    <div className="col-md-10 offset-md-1 text-justify">
                      ...
                      <p>
                      If you need services for multiple custom images please let me know so I can offer discounts.
                      </p>
                    </div>
                  </div>
                </article>
