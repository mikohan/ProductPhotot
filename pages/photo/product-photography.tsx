...
const Projects: NextPage = () => {
  ...
  return (
    <Fragment>
      <Head>
        <title>Product Photography Services - {company.companyName}</title>
        <meta
          name="description"
          content={`Product Photography Services by our creative photo studio - ${company.companyName}`}
        />
      </Head>
      <PageProgress />
            ...
            <div className="container py-13 py-md-17 text-center">
              <div className="row">
                <div className="col-lg-10 col-xxl-8 mx-auto">
                  <h1 className="display-1 mb-1">Product Photography Service</h1>
                </div>
              </div>
            </div>
          </div>
